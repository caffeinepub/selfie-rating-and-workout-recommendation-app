...
import type { CrossRealityScore as _CrossRealityScore, ImageResult as _ImageResult, SelfieSession as _SelfieSession, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllSessions(): Promise<Array<SelfieSession>> {
        if (this.processError) {
            try {
    ...
    async getCurrentCrossRealityScore(): Promise<number> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentCrossRealityScore();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitSelfie(arg0: SessionInput): Promise<CrossRealityScore> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSelfie(arg0);
                return from_candid_CrossRealityScore_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_CrossRealityScore_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CrossRealityScore): CrossRealityScore {
    return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_ImageResult_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ImageResult): ImageResult {
    return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_SelfieSession_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SelfieSession): SelfieSession {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        score: from_candid_CrossRealityScore_n13(_uploadFile, _downloadFile, value.score),
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        details: from_candid_vec_n15(_uploadFile, _downloadFile, value.details),
        rating: value.rating
    };
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "goodLighting" in value ? ImageResult.goodLighting : "centeredFace" in value ? ImageResult.centeredFace : "smileDetected" in value ? ImageResult.smileDetected : value;
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SelfieSession>): Array<SelfieSession> {
    return value.map((x)=>from_candid_SelfieSession_n11(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ImageResult>): Array<ImageResult> {
    return value.map((x)=>from_candid_ImageResult_n16(_uploadFile, _downloadFile, x));
}
